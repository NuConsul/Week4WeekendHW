...
public class List implements Parcelable
{
    ...
    protected List(Parcel in) {
        ...
        in.readList(this.weather, (com.chemwater.mylibrary.retrofit.models.Weather.class.getClassLoader()));
     ...
     * @param main
     */
    public List(Integer dt, Main main, java.util.List<Weather> weather, Clouds clouds, Wind wind, Rain rain, Snow snow, Sys sys, String dtTxt) {
        super();
        this.dt = dt;
        this.main = main;
